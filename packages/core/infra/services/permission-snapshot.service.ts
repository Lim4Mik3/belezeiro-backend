...
import type { IAuthzSnapshot } from "@core/app/contracts/i-authz-snapshot";
import type { IRoleAssignmentRepository } from "@core/app/contracts/repositories/i-role-assignment-repository";
import type { IRoleDefinitionRepository } from "@core/app/contracts/repositories/i-role-definition-repository";
import type { IUserRepository } from "@core/app/contracts/repositories/i-user-repository";
import { STANDARD_ROLES } from "@core/domain/constants/role-names";
import type { IPermissionSnapshotService } from "@core/app/contracts/services/i-permissions-snapshot-service";
import { CreateUserPermissionSnapshotCacheKey } from "@core/infra/utils/create-user-permission-snapshot-cache-key.utils";
